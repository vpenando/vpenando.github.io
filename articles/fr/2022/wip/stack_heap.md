...
```
Ces opérations constituent l'**épilogue** d'une fonction, et visent à restaurer l'état de la pile tel qu'il était auparavant. Ainsi, le "stack frame" de la fonction appelante réécrira par-dessus celui de `foo`, qui n'est plus utile.
