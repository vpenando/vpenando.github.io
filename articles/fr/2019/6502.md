...
Si vous êtes attentifs, vous remarquerez que l'on a là un magnifique cas de boucle infinie ! C'est là qu'intervient l'instruction `rts` ("**R**e**T**urn from **S**ubroutine") :
```asm
mon_label:
    lda #$00
    tax
