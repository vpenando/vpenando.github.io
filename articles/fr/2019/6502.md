...
Concrètement, seule les sept premières pages (soit la plage d'adresses entre `$0000` et `$0800` exclue) sont réellement consacrées à la RAM adressable.
