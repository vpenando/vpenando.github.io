...
Chaque sprite est décrit via 4 octets, comme présenté sur [cette page](http://wiki.nesdev.com/w/index.php/PPU_OAM).

Nous ne parlerons pas outre mesure du PPU (**P**icture **P**rocessing **U**nit) ni de l'APU (**A**udio **P**rocessing **U**nit) ici, qui mériteraient chacun un article.
